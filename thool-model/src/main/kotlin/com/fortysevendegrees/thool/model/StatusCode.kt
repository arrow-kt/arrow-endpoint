...
class StatusCode(val code: Int) {
  fun isInformational(): Boolean = code / 100 == 1
  fun isSuccess(): Boolean = code / 100 == 2
  fun isRedirect(): Boolean = code / 100 == 3
  fun isClientError(): Boolean = code / 100 == 4
  fun isServerError(): Boolean = code / 100 == 5
