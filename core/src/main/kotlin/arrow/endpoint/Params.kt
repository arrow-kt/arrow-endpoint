...
/**
 * TODO rewrite to Result<A> like type, value class that wraps the union
 *
 * A union type: Unit | value | Array<Any?<. Represents the possible parameters of an endpoint's
 * input/output: no parameters, a single parameter (a "stand-alone" value instead of a 1-tuple), and
 * multiple parameters.
 *
 * There are two views on parameters: [ParamsAsAny], where the parameters are represented as
 * instances of the union type, or [ParamsAsList], where the parameters are represented as a vector
 * of size 0/1/2+.
 */
  ...
  public data class ParamsAsAny(override val asAny: Any?) : Params() {
    ...
    private fun toParams(a: Any?): List<Any?> =
      when (a) {
        ...
        is Tuple6<*, *, *, *, *, *> ->
          listOf(a.first, a.second, a.third, a.fourth, a.fifth, a.sixth)
        is Tuple7<*, *, *, *, *, *, *> ->
          listOf(a.first, a.second, a.third, a.fourth, a.fifth, a.sixth, a.seventh)
        is Tuple8<*, *, *, *, *, *, *, *> ->
          listOf(a.first, a.second, a.third, a.fourth, a.fifth, a.sixth, a.seventh, a.eighth)
        is Tuple9<*, *, *, *, *, *, *, *, *> ->
          listOf(
            a.first,
            a.second,
