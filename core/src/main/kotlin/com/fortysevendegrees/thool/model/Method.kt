...
/* inline */ class Method private constructor(val value: String) {
  ...
  /**
   * An HTTP com.fortysevendegrees.thool.method is idempotent if an identical request can be made once or several times in a row with the same
  ...
  /**
   * An HTTP com.fortysevendegrees.thool.method is safe if it doesn't alter the state of the server.
  ...
  companion object {
    ...
    /**
     * Parse HTTP com.fortysevendegrees.thool.method by [method] string
     */
