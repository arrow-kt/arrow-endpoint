...
import com.fortysevendegrees.tapir.DecodeResult.Failure.Multiple
...
import com.fortysevendegrees.tapir.basicInputSortIndex
...
object DecodeBasicInputs {
  ...
  /** Decodes values of all basic inputs defined by the given `input`, and returns a com.fortysevendegrees.tapir.map from the input to the
   * input's value.
   *
  ...
  private fun apply(input: EndpointInput<*>, ctx: DecodeInputsContext): DecodeBasicInputsResult {
    ...
    // An exact-path check is done after tapir.method & path matching
